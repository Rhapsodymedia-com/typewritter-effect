				...
				function pageChangedCallbackText() {
					...
					class TxtType {
						constructor(el, wordRotate, period, erase) {
							...
							this.textNode = this.el.querySelector(".typewriter-text");
							this.cursorNode = this.el.querySelector(".typewriter-cursor");
							...
							if (!this.textNode || !this.cursorNode) {
								...
								this.textNode.style.font = "inherit";
								this.textNode.style.fontFamily = "inherit";
								this.textNode.style.fontSize = "inherit";
								this.textNode.style.fontWeight = "inherit";
								this.textNode.style.fontStyle = "inherit";
								this.textNode.style.lineHeight = "inherit";
								this.textNode.style.letterSpacing = "inherit";
								this.textNode.style.textTransform = "inherit";
								this.textNode.style.textDecoration = "inherit";
								this.textNode.style.textAlign = "inherit";
								this.textNode.style.color = "inherit";
								this.textNode.style.whiteSpace = "inherit";
								this.textNode.style.wordBreak = "inherit";
								this.textNode.style.overflowWrap = "inherit";
							...
							this.cursorNode.style.borderRight =
								`0.08em solid ${cursorColor || getComputedStyle(this.el).color}`;
						...
						tick() {
							...
							const color = cursorColor || getComputedStyle(this.el).color;
